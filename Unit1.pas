...
Uses
   ExemploLoginPWAWebApp, Unit_Camera;
...
begin
 if Form_Camera = nil then
   TForm_Camera.CreateInstance;
 Form_Camera.Show;
end;
...
begin
 ...
 // manifest
 D2Bridge.HTML.StyleSheets.Add('<link  rel="stylesheet"  type="text/css" href="css/Dashboard-HdWFjXwp.css">');
